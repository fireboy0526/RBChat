package com.skws.rbchat.service;
...
import com.skws.rbchat.util.NotificationUtils;
import com.skws.rbchat.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        if (!NotificationUtils.isAppInBackground(getApplicationContext())) {
            // App is in foreground, broadcast the push notification
            ...
            // If app is in background, firebase will handle it.
        }
    }
